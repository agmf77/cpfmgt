...
import { useCollection, useFirestore, useMemoFirebase, addDocumentNonBlocking, deleteDocumentNonBlocking, updateDocumentNonBlocking, addDocWithFallback } from "@/firebase";
      ...
      try {
        ...
        for (const entry of data as any[]) {
          ...
          if (memberData.memberIdNumber && memberData.name) {
            const memberRef = await addDocWithFallback(collection(firestore, "members"), memberData);
            ...
            await addDocWithFallback(collection(firestore, "members", memberRef.id, "fundSummaries"), openingEntry);
            count++;
          }
        }
        showAlert({ 
