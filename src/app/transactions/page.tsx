...
import { localCollection, localDoc } from "@/lib/local-collection-helpers";
...
export default function TransactionsPage() {
  ...
  const entriesRef = useMemoFirebase(() => localCollection("journalEntries"), []);
  ...
  const handleDelete = (id: string, ref: string) => {
    showAlert({
      ...
      onConfirm: () => {
        const docRef = localDoc("journalEntries", id);
        deleteDocumentNonBlocking(docRef as any);
        showAlert({
          title: "Deleted",
