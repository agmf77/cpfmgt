...
export function SweetAlertProvider({ children }: { children: ReactNode }) {
  ...
  const [resolveResult, setResolveResult] = useState<((value: boolean) => void) | null>(null)

  const showAlert = useCallback(
    (titleOrOptions: SweetAlertOptions | string, description?: string, type?: "success" | "error" | "warning" | "info", showCancel?: boolean) => {
      const nextOptions: SweetAlertOptions =
